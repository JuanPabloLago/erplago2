...
#
#   [DOC] Refs ./toolkit_v56.sh -> ./toolkit_v57.sh en help y comandos.
#
...
#
# Uso: ./toolkit_v57.sh [comando] [opciones]
# =======================================================================================
...
rastrear_uso_tabla() {
    ...
    if [ -z "$tabla" ]; then
        echo -e "${RED}[ERROR] Especifica una tabla. Ej: ./toolkit_v57.sh rastrear movimientos_caja${NC}"
        return 1
    fi
...
- Antes de tocar tabla critica: ./toolkit_v57.sh rastrear nombre_tabla
...
informe_completo() {
    ...
    echo -e "  Contexto + Arquitectura + Salud + Seguridad + Prompt Maestro"
    echo ""
    ...
    echo -e "  ${CYAN}[1/5]${NC} Contexto IA (incluye versiones)..."
    generar_contexto_ia

    # Paso 2: Arquitectura de negocio
    echo -e "  ${CYAN}[2/5]${NC} Arquitectura de negocio..."
    documentar_arquitectura_negocio

    # Paso 3: Salud arquitectónica
    echo -e "  ${CYAN}[3/5]${NC} Salud arquitectonica..."
    generar_informe_salud

    # [v36] Paso 4: Seguridad
    echo -e "  ${CYAN}[4/5]${NC} Seguridad y control de acceso..."
    auditar_seguridad

    # Paso 5: Prompt maestro
    echo -e "  ${CYAN}[5/5]${NC} Prompt maestro..."
    prompt_maestro
    ...
    case "$key" in
        ...
        *)
            ...
            case "$key" in
                ...
                help*) ejecutar_accion 14 "$2"; return ;;
                migra*) ejecutar_accion 15 "$2"; return ;;
                feat*|colum*|endp*) ejecutar_accion 16 "$2"; return ;;
                modul*|list*) ejecutar_accion 17 "$2"; return ;;
                tend*|tren*|histo*) ejecutar_accion 18 "$2"; return ;;
            esac
...
menu_principal() {
    while true; do
        ...
        echo -e "  ${CYAN} 2${NC} Auditar modulo      ${RED} 8${NC} Seguridad           ${MAGENTA}14${NC} Helpers"
        echo -e "  ${RED} 3${NC} Rastrear tabla      ${YELLOW} 9${NC} Multi-empresa       ${MAGENTA}15${NC} Migracion"
        echo -e "  ${MAGENTA} 4${NC} Prompt maestro     ${GREEN}10${NC} Datos semilla       ${GREEN}16${NC} Features"
        echo -e "  ${CYAN} 5${NC} Contexto IA        ${YELLOW}11${NC} Constraints/triggs  ${CYAN}17${NC} Modulos"
        echo -e "  ${BLUE} 6${NC} Arquitectura       ${CYAN}12${NC} Impresion           ${CYAN}18${NC} Tendencia"
...
mostrar_ayuda() {
    cat << 'HELP'
ERP LAGO - Toolkit IA v57.0

Uso: ./toolkit_v57.sh [comando]
...
EJEMPLOS:
  ./toolkit_v57.sh                              # Menu interactivo
  ./toolkit_v57.sh completo                     # Genera TODO directo
  ./toolkit_v57.sh rastrear movimientos_caja    # Rastreo especifico
  ./toolkit_v57.sh impresion                    # Mapeo 3 caminos de impresion
  ./toolkit_v57.sh lago                         # Estado lago.ar
HELP
}
