...
\restrict xzlVd1A2xwtplFUlRyFoERnfx9opO5QqX1PIyWOM7Ur0CScN3rAX7E0Udr4HqRw
...
CREATE TABLE public.dispositivos_autorizados (
    ...
    baja_por integer,
    motivo_baja text,
    CONSTRAINT chk_dispositivos_estado CHECK (((estado)::text = ANY ((ARRAY['activo'::character varying, 'baja'::character varying])::text[])))
);
...
COPY public.dispositivos_autorizados (id_dispositivo, id_empresa, id_usuario, fingerprint_hash, nombre_dispositivo, navegador, sistema_operativo, ip_hash, fecha_registro, ultimo_acceso, activo, autorizado_por, fecha_autorizacion, notas, estado, fecha_baja, baja_por, motivo_baja) FROM stdin;
15	1	5	d0f68874d07a80e6581a0b6cc23fde39db7b78a3b19079add65a4672db60506d	mirta	Chrome	Windows	65552d9cdece19fe480693c73020ca095c1603bcf6482bcbfdf8935a7e2365a9	2026-04-16 08:54:03.678597	2026-05-09 08:42:35.546013	t	2	2026-04-16 08:54:03.678597		activo	\N	\N	\N
13	1	6	5f4df5925fdd2d65b2de920277f6e8b6c971ace7708d0bb0d936a6c4bbb7c95c	david	Chrome	Windows	c9c21db0dc910a7c6c3779d5a0c347d9799dfe0d3541673b77c71f9e8f8e6969	2026-04-16 08:53:36.812903	2026-05-09 08:45:21.944517	t	2	2026-04-16 08:53:36.812903		activo	\N	\N	\N
16	1	5	c5c6975e20a407b6e0e28d3a7fe074273a70e11d28d0aa0eae82d228aa829617	Mirt	Chrome	Windows	65552d9cdece19fe480693c73020ca095c1603bcf6482bcbfdf8935a7e2365a9	2026-05-11 08:02:41.061151	2026-06-01 08:32:35.612192	t	2	2026-05-11 08:02:41.061151		activo	\N	\N	\N
17	1	6	88b08ac64aef66e8e4ccdfaf2c385f4c990435a1321bf0056396130ba73159c8	David	Chrome	Windows	c9c21db0dc910a7c6c3779d5a0c347d9799dfe0d3541673b77c71f9e8f8e6969	2026-05-11 08:15:25.124585	2026-06-01 08:32:54.030784	t	2	2026-05-11 08:15:25.124585		activo	\N	\N	\N
\.
...
--
-- Name: dispositivos_autorizados dispositivos_autorizados_baja_por_fkey; Type: FK CONSTRAINT; Schema: public; Owner: juanpablo
--

ALTER TABLE ONLY public.dispositivos_autorizados
    ADD CONSTRAINT dispositivos_autorizados_baja_por_fkey FOREIGN KEY (baja_por) REFERENCES public.usuarios(id_usuario);
...
\unrestrict xzlVd1A2xwtplFUlRyFoERnfx9opO5QqX1PIyWOM7Ur0CScN3rAX7E0Udr4HqRw
